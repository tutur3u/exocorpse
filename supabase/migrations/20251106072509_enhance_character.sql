...
alter table "public"."characters" drop column "skills";
alter table "public"."characters" drop column "strengths";
alter table "public"."characters" drop column "weaknesses";

alter table "public"."characters" add column "fanwork_policy" text;
alter table "public"."characters" add column "color_palette" varchar(7)[];
