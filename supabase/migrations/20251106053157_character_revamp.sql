...
alter table "public"."characters" drop column "like_count";

alter table "public"."characters" drop column "view_count";

alter table "public"."characters" add column "featured_image" text;

alter table "public"."characters" add column "quote" text;
