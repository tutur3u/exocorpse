...
export default function WorldsClient({ initialStories }: WorldsClientProps) {
      ...
      {!selectedStoryId ? (
        <div className="rounded-lg border border-gray-200 bg-white p-12 text-center dark:border-gray-800 dark:bg-gray-950">
          ...
          <h3 className="mb-2 text-lg font-semibold text-gray-900 dark:text-gray-100">
            Select a story to manage worlds
          </h3>
          <p className="text-gray-600 dark:text-gray-400">
            Choose a story from the dropdown above to view and manage its worlds
          </p>
        </div>
      ) : worldsLoading ? (
