    ...
    if (viewMode === "worlds") {
      return (
        <div className="flex h-full flex-col overflow-hidden">
          <div className="border-b border-gray-200 p-4 pb-0 dark:border-gray-700">
            {renderBreadcrumbs()}
          ...
          {contentItems.length === 0 ? (
            ...
            <div className="h-[calc(100%-3rem)] overflow-hidden">
              <ListDetail
                ...
                renderDetail={(item) => (
                  <div className="space-y-4">
                    <div className="inline-block rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-600 dark:border-gray-700 dark:text-gray-400">
                      {item.data.type === "character" ? "Character" : "Faction"}
                    </div>
                    {item.data.type === "character" &&
                    "nickname" in item.data &&
                    item.data.nickname ? (
