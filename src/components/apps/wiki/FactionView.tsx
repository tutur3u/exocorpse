        ...
        <div className="border-b bg-white/50 p-6 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-900/50">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {faction.faction_type && (
              <span className="bg-theme-primary rounded-full px-3 py-1 text-sm font-medium text-white">
                {faction.faction_type}
              </span>
            )}
            {faction.status && (
              <span className="bg-theme-secondary rounded-full px-3 py-1 text-sm font-medium text-white">
                {faction.status}
              </span>
            )}
            {faction.reputation && (
