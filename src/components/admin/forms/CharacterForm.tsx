...
export default function CharacterForm({
  ...
  return (
    <>
      <div
        className="bg-opacity-50 animate-fadeIn fixed inset-0 z-50 flex h-screen w-screen items-end justify-center overflow-hidden bg-black sm:items-center sm:p-4"
        role="button"
        tabIndex={0}
      ...
      >
        ...
        >
          ...
          {/* Tabs - Desktop */}
          <div className="hidden shrink-0 gap-1 overflow-x-auto border-b border-gray-300 px-4 sm:flex sm:px-6 dark:border-gray-600">
            <button
              type="button"
          ...
          >
            ...
            {/* Form Actions */}
            <div className="sticky bottom-0 flex shrink-0 flex-col-reverse items-stretch gap-2 border-t border-gray-300 bg-white/95 px-4 py-4 pb-[calc(env(safe-area-inset-bottom)+1rem)] backdrop-blur sm:flex-row sm:justify-end sm:px-6 sm:pb-4 dark:border-gray-600 dark:bg-gray-800/95">
              <button
                type="button"
