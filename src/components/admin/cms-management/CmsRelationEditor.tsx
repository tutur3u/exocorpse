...
function RelationControl({
  ...
  return (
    <div className="space-y-2 rounded-xl border border-zinc-200/80 bg-zinc-50/60 p-3 dark:border-zinc-800 dark:bg-zinc-950/50">
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="block truncate text-[10px] text-zinc-500 dark:text-zinc-400">
                  {collectionById.get(entry.collection_id)} · /{entry.slug}
                </span>
              </span>
    ...
    <section className="space-y-4 rounded-2xl border border-zinc-200/80 bg-white/70 p-4 dark:border-zinc-800 dark:bg-zinc-900/40">
      <div>
        ...
        <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
          Relations are validated transactionally by Tuturuuu CMS.
        </p>
      </div>
