            ...
            {items.map((item) => (
              <div
                ...
                className={
                  renderItemCard
                    ? "overflow-visible"
                    : "group cursor-pointer rounded-lg border border-gray-200 bg-white p-4 text-left shadow-sm transition hover:-translate-y-1 hover:shadow-md dark:border-gray-800 dark:bg-gray-900"
                }
              >
                {renderItemCard ? (
                  renderItemCard(item)
